...
public partial class MainLayout : MainLayoutBase
{
    internal override IEnumerable<NavItem> GetNavItems()
    {
        navItems ??= new List<NavItem>
        {
            ...
            new (){ Id = "403", Text = "Email Input", Href = "/form/email-input", IconName = IconName.Mailbox, ParentId = "4" },
            new (){ Id = "404", Text = "Number Input", Href = "/form/number-input", IconName = IconName.InputCursor, ParentId = "4" },
            new (){ Id = "405", Text = "Radio Input", Href = "/form/radio-input", IconName = IconName.Circle, ParentId = "4" },
            new (){ Id = "406", Text = "Range Input", Href = "/form/range-input", IconName = IconName.Sliders, ParentId = "4" },
            new (){ Id = "407", Text = "Switch", Href = "/form/switch", IconName = IconName.ToggleOn, ParentId = "4" },
            new (){ Id = "408", Text = "Time Input", Href = "/form/time-input", IconName = IconName.ClockFill, ParentId = "4" },
            new (){ Id = "409", Text = "Text Input", Href = "/form/text-input", IconName = IconName.InputCursorText, ParentId = "4" },
